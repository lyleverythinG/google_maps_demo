...
class MapServices {
  ...
  Future<List<AutoCompleteResult>> searchPlaces(
  ...
  Future<dynamic> getPlaceDetails(
      {required LatLng pos, required int radius}) async {
  ...
  Future<dynamic> getMorePlaceDetails({required String token}) async {
    final String url =
